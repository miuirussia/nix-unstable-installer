...
* Release: `nix-2.4pre20210924_a0bb5c4`
* Hydra eval: https://hydra.nixos.org/eval/1707776
...
```sh
sh <(curl -L https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.4pre20210924_a0bb5c4/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v14
      with:
        install_url: https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.4pre20210924_a0bb5c4/install
