...
* Release: `nix-2.12.0pre20221201_ca42068`
* Hydra eval: https://hydra.nixos.org/eval/1786607
...
```sh
sh <(curl -L https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.12.0pre20221201_ca42068/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v14
      with:
        install_url: https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.12.0pre20221201_ca42068/install
