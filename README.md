...
* Release: `nix-2.15.0pre20230401_2ef99cd`
* Hydra eval: https://hydra.nixos.org/eval/1792926
...
```sh
sh <(curl -L https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.15.0pre20230401_2ef99cd/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v14
      with:
        install_url: https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.15.0pre20230401_2ef99cd/install
