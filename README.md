...
* Release: `nix-2.12.0pre20221108_ffca3e3`
* Hydra eval: https://hydra.nixos.org/eval/1785064
...
```sh
sh <(curl -L https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.12.0pre20221108_ffca3e3/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v14
      with:
        install_url: https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.12.0pre20221108_ffca3e3/install
