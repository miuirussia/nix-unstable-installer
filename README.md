...
* Release: `nix-2.6.0pre20220111_d023903`
* Hydra eval: https://hydra.nixos.org/eval/1737663
...
```sh
sh <(curl -L https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.6.0pre20220111_d023903/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v14
      with:
        install_url: https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.6.0pre20220111_d023903/install
