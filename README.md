...
* Release: `nix-2.17.0pre20230606_bf7dc3c`
* Hydra eval: https://hydra.nixos.org/eval/1796115
...
```sh
sh <(curl -L https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.17.0pre20230606_bf7dc3c/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v14
      with:
        install_url: https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.17.0pre20230606_bf7dc3c/install
