...
* Release: `nix-2.14.0pre20230210_c184566`
* Hydra eval: https://hydra.nixos.org/eval/1790492
...
```sh
sh <(curl -L https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.14.0pre20230210_c184566/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v14
      with:
        install_url: https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.14.0pre20230210_c184566/install
