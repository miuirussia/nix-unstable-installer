...
* Release: `nix-2.12.0pre20220920_9dadb54`
* Hydra eval: https://hydra.nixos.org/eval/1781424
...
```sh
sh <(curl -L https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.12.0pre20220920_9dadb54/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v14
      with:
        install_url: https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.12.0pre20220920_9dadb54/install
