...
* Release: `nix-2.12.0pre20221107_b378876`
* Hydra eval: https://hydra.nixos.org/eval/1784953
...
```sh
sh <(curl -L https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.12.0pre20221107_b378876/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v14
      with:
        install_url: https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.12.0pre20221107_b378876/install
