...
* Release: `nix-2.7.0pre20220208_0b3d8e1`
* Hydra eval: https://hydra.nixos.org/eval/1742942
...
```sh
sh <(curl -L https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.7.0pre20220208_0b3d8e1/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v14
      with:
        install_url: https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.7.0pre20220208_0b3d8e1/install
