...
* Release: `nix-2.8.0pre20220414_d6effdd`
* Hydra eval: https://hydra.nixos.org/eval/1755512
...
```sh
sh <(curl -L https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.8.0pre20220414_d6effdd/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v14
      with:
        install_url: https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.8.0pre20220414_d6effdd/install
