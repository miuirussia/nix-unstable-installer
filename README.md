...
* Release: `nix-2.10.0pre20220714_ca4d5be`
* Hydra eval: https://hydra.nixos.org/eval/1771504
...
```sh
sh <(curl -L https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.10.0pre20220714_ca4d5be/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v14
      with:
        install_url: https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.10.0pre20220714_ca4d5be/install
