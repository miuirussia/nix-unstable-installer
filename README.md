...
* Release: `nix-2.20.0pre20231120_065cd5b`
* Hydra eval: https://hydra.nixos.org/eval/1801982
...
```sh
sh <(curl -L https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.20.0pre20231120_065cd5b/install)
```
...
jobs:
  tests:
    ...
    - uses: cachix/install-nix-action@v14
      with:
        install_url: https://github.com/miuirussia/nix-unstable-installer/releases/download/nix-2.20.0pre20231120_065cd5b/install
